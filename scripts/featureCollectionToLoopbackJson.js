...
const intermediateZones = 'intermediate-zones-2001.geojson';
const model = 'SchoolPupilCensus';
const filename = 'school-pupil-census';
...
featureCollection = fs.readFileSync(path.join(datadir, intermediateZones), 'utf8');
